...
public class SqliteOutboxBuilderTests
{
    ...
    {
        var builder = new SqliteOutboxBuilder().UseUnitOfWork(true);
    ...
    {
        var builder = new SqliteOutboxBuilder().EnableUnitOfWork();
        Assert.True(GetPrivateField<bool>(builder, "_useUnitOfWork"));
    }
    ...
    {
        var builder = new SqliteOutboxBuilder().DisableUnitOfWork();
    ...
    public void UnitOfWorkConnectionProvider_SetsProvider()
    {
        ...
        var builder = new SqliteOutboxBuilder().UnitOfWorkConnectionProvider(mockProvider);
    ...
    public void Build_ReturnsCorrectConfigurationWithDefaults()
    {
        ...
        Assert.IsType<SqliteOutbox>(result.Outbox);
    }
