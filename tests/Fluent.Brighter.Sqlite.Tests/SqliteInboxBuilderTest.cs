...
public class SqliteInboxBuilderTest
{
     ...
     public void Configuration_WithRelationalConfig_SetsValue()
     {
         ...
         var builder = new SqliteInboxBuilder().Configuration(config);
     ...
     public void ConfigurationIfIsMissing_WhenAlreadySet_DoesNotOverwrite()
     {
         ...
         var builder = new SqliteInboxBuilder().Configuration(initialConfig);
         builder.ConfigurationIfIsMissing(defaultConfig);
     ...
     {
         var config = new RelationalDatabaseConfiguration(TestConnectionString);
         var builder = new SqliteInboxBuilder().Configuration(config).DisableUnitOfWork();
