...
public class PostgresInboxConfigurationBuilder
{
    ...
    public PostgresInboxConfigurationBuilder Scope(InboxScope scope)
    {
        _scope = scope;
        return this;
    }
    ...
    /// <returns>The current builder instance for fluent chaining.</returns>
    public PostgresInboxConfigurationBuilder OnceOnly(bool onceOnly)
    {
        _onceOnly = onceOnly;
        return this;
    }
    ...
    /// <returns>The current builder instance for fluent chaining.</returns>
    public PostgresInboxConfigurationBuilder ActionOnExists(OnceOnlyAction actionOnExists)
    {
    ...
    /// <returns>The current builder instance for fluent chaining.</returns>
    public PostgresInboxConfigurationBuilder Context(Func<Type, string>? context)
    {
        _context = context;
        return this;
    }
    ...
    /// <returns>The current builder instance for fluent chaining.</returns>
    public PostgresInboxConfigurationBuilder Configuration(RelationalDatabaseConfiguration? configuration)
    {
    ...
    /// <param name="configuration">An instance of <see cref="RelationalDatabaseConfiguration"/>.</param>
    /// <returns>The current builder instance for fluent chaining.</returns>
    public PostgresInboxConfigurationBuilder Configuration(Action<RelationalDatabaseConfigurationBuilder> configuration)
    {
    ...
    /// <returns>The current builder instance for fluent chaining.</returns>
    public PostgresInboxConfigurationBuilder UseUnitOfWork(bool useUnitOfWork)
    {
    ...
    /// </summary>
    /// <returns>The current builder instance for fluent chaining.</returns>
    public PostgresInboxConfigurationBuilder EnableUnitOfWork() => UseUnitOfWork(true);
    
    /// <summary>
    /// Disable to use a unit of work with the inbox.
    /// </summary>
    /// <returns>The current builder instance for fluent chaining.</returns>
    public PostgresInboxConfigurationBuilder DisableUnitOfWork() => UseUnitOfWork(false);
