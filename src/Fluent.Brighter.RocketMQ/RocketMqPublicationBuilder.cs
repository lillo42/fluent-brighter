...
/// <summary>
/// Fluent builder for configuring RocketMQ message publication settings in Brighter
/// </summary>
/// <remarks>
...
/// </remarks>
public sealed class RocketMqPublicationBuilder
{
    ...
    public RocketMqPublicationBuilder SetDataSchema(Uri? dataSchema)
    {
    ...
    /// <returns>This builder for fluent chaining</returns>
    public RocketMqPublicationBuilder SetMakeChannels(OnMissingChannel makeChannels)
    {
    ...
    /// <returns>This builder for fluent chaining</returns>
    public RocketMqPublicationBuilder SetRequestType(Type? requestType)
    {
    ...
    /// <returns>This builder for fluent chaining</returns>
    public RocketMqPublicationBuilder SetSource(Uri source)
    {
        _source = source;
        return this;
    }
    ...
    /// <returns>This builder for fluent chaining</returns>
    public RocketMqPublicationBuilder SetSubject(string? subject)
    {
        _subject = subject;
        return this;
    }
    ...
    /// <summary>
    /// Sets the RocketMQ routing key/topic (optional)
    /// </summary>
    /// <param name="topic">Routing key for message distribution</param>
    /// <returns>This builder for fluent chaining</returns>
    public RocketMqPublicationBuilder SetTopic(RoutingKey? topic)
    {
        _topic = topic;
        return this;
    }
    ...
    /// <returns>This builder for fluent chaining</returns>
    public RocketMqPublicationBuilder SetType(CloudEventsType type)
    {
        _type = type;
        return this;
    }
    ...
    /// <returns>This builder for fluent chaining</returns>
    public RocketMqPublicationBuilder SetDefaultHeaders(IDictionary<string, object>? defaultHeaders)
    {
    ...
    /// <returns>This builder for fluent chaining</returns>
    public RocketMqPublicationBuilder SetCloudEventsAdditionalProperties(
    ...
    /// <returns>This builder for fluent chaining</returns>
    public RocketMqPublicationBuilder SetReplyTo(string? replyTo)
    {
        _replyTo = replyTo;
        return this;
    }
    ...
    /// Set the topic tags
    /// </summary>
    /// <param name="tags">Tha tags</param>
    /// <returns>This builder for fluent chaining</returns>
    public RocketMqPublicationBuilder SetTags(string? tags)
    {
        _tags = tags;
        return this;
    }
    ...
    /// <returns>This builder for fluent chaining</returns>
    public RocketMqPublicationBuilder SetInstrumentation(InstrumentationOptions options)
    {
