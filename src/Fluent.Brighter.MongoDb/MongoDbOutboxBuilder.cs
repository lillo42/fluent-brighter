...
/// Provides a clean, readable API for configuring outbox behavior and MongoDB-specific settings.
/// </summary>
public class MongoDbOutboxBuilder
{
    ...
    public MongoDbOutboxBuilder MaxOutStandingMessages(int? maxOutStandingMessages)
    {
    ...
    /// <returns>The current builder instance for fluent chaining.</returns>
    public MongoDbOutboxBuilder MaxOutStandingCheckInterval(TimeSpan maxOutStandingCheckInterval)
    {
    ...
    /// <returns>The current builder instance for fluent chaining.</returns>
    public MongoDbOutboxBuilder BulkChunkSize(int? outboxBulkChunkSize)
    {
    ...
    /// <returns>The current builder instance for fluent chaining.</returns>
    public MongoDbOutboxBuilder Bag(Dictionary<string, object>? outBoxBag)
    {
    ...
    /// <returns>The current builder instance for fluent chaining.</returns>
    public MongoDbOutboxBuilder Timeout(int? outboxTimeout)
    {
    ...
    /// <returns>The current builder instance for fluent chaining.</returns>
    public MongoDbOutboxBuilder Connection(MongoDbConfiguration? configuration)
    {
    ...
    /// <param name="configuration">An instance of <see cref="MongoDbConfiguration"/>.</param>
    /// <returns>The current builder instance for fluent chaining.</returns>
    public MongoDbOutboxBuilder Connection(Action<MongoDbConfigurationBuilder> configuration)
    {
    ...
    /// <param name="configuration">An instance of <see cref="MongoDbConfiguration"/>.</param>
    /// <returns>The current builder instance for fluent chaining.</returns>
    public MongoDbOutboxBuilder SetConnectionIfIsMissing(MongoDbConfiguration? configuration)
    {
        _configuration ??= configuration;
        return this;
    }
    ...
    public BrighterOutboxConfiguration Build()
    {
        return new BrighterOutboxConfiguration
        {
            ...
            Outbox = new MongoDbOutbox(_configuration) 
        };
    }
}