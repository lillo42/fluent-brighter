...
public static class ConsumerBuilderExtensions
{
    ...
    public static ConsumerBuilder AddPubSubSubscription(
    ...
    /// <param name="configure">An action to configure the <see cref="GcpPubSubSubscriptionBuilder"/>.</param>
    /// <returns>The consumer builder for method chaining.</returns>
    public static ConsumerBuilder AddPubSubSubscription<TRequest>(
        this ConsumerBuilder builder,
        Action<GcpPubSubSubscriptionBuilder> configure
    )
    ...
    /// <returns>The consumer builder for method chaining.</returns>
    public static ConsumerBuilder AddPubSubChannelFactory(
        this ConsumerBuilder builder,
    ...
    /// <returns>The consumer builder for method chaining.</returns>
    public static ConsumerBuilder UseFirestoreInbox(
        this ConsumerBuilder builder,
    ...
    {
        return builder.UseFirestoreInbox(cfg =>
            cfg.SetConfiguration(c =>
                c.SetCredential(connection.Credential)
    ...
    /// <returns>The consumer builder for method chaining.</returns>
    public static ConsumerBuilder UseSpannerInbox(
        this ConsumerBuilder builder,
    ...
    {
        return builder.UseSpannerInbox(cfg =>
            cfg.SetConfiguration(c =>
                c.SetConnectionString(connectionString).SetInboxTableName("inbox")
            )
        );
    }
