...
public static class RmqSubscriptionBuilderExtensions
{
    ...
    #region QueueType
    /// <summary>
    /// Configures the queue as a Classic RabbitMQ queue
    /// </summary>
    /// <remarks>
    /// Default queue type. Suitable for most workloads. Not as resilient as Quorum queues.
    /// </remarks>
    /// <param name="builder">Subscription builder</param>
    /// <returns>Configured subscription builder</returns>
    ...
    /// <summary>
    /// Configures the queue as a Quorum queue
    /// </summary>
    /// <remarks>
    /// Recommended for critical data. Provides better data safety through Raft consensus.
    /// Requires RabbitMQ 3.8+.
    /// </remarks>
    /// <param name="builder">Subscription builder</param>
    /// <returns>Configured subscription builder</returns>
